...
export const api = {
  ...
  registerPushToken: (token, input) =>
    apiRequest('/auth/me/push-tokens', { method: 'POST', token, body: input }),
  updateNotificationPreferences: (token, input) =>
    apiRequest('/auth/me/notification-preferences', { method: 'PATCH', token, body: input }),
